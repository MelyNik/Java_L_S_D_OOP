package Java_L_S_D_ooP.Lectures.task_2.Ex003;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

import Java_L_S_D_ooP.Lectures.task_2.Ex003.alliance.*;
import Java_L_S_D_ooP.Lectures.task_2.Ex003.*;
...
public class Program {
    public static void main(String[] args) {
        ...
        //BaseHero druid = new Druid(); Или так.
        ...
        priest.attack(magician);
        System.out.println(magician.getInfo());
        // ((Druid)(druid)).healing(magician); + так.
